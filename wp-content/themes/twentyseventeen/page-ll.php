...
function displayTable() {
	$element('llTableHead').innerHTML = "<th>FIRST集合</th><th>FOLLOW集合</th><th>非终结符</th>";
...
<td>
<div>
<table border="1"><thead><tr id="llTableHead"><th>FIRST集合</th><th>FOLLOW集合</th><th>非终结符</th><th>+</th><th>*</th><th>(</th><th>)</th><th>id</th><th>$</th></tr></thead><tbody id="llTableRows"><tr></tr><tr><td nowrap="nowrap">{(,id}</td><td nowrap="nowrap">{$,)}</td><td nowrap="nowrap">E</td><td nowrap="nowrap"></td><td nowrap="nowrap"></td><td nowrap="nowrap">E -&gt; T E'</td><td nowrap="nowrap"></td><td nowrap="nowrap">E -&gt; T E'</td><td nowrap="nowrap"></td></tr><tr></tr><tr><td nowrap="nowrap">{+,''}</td><td nowrap="nowrap">{$,)}</td><td nowrap="nowrap">E'</td><td nowrap="nowrap">E' -&gt; + T E'</td><td nowrap="nowrap"></td><td nowrap="nowrap"></td><td nowrap="nowrap">E' -&gt; ''</td><td nowrap="nowrap"></td><td nowrap="nowrap">E' -&gt; ''</td></tr><tr></tr><tr><td nowrap="nowrap">{(,id}</td><td nowrap="nowrap">{+,$,)}</td><td nowrap="nowrap">T</td><td nowrap="nowrap"></td><td nowrap="nowrap"></td><td nowrap="nowrap">T -&gt; F T'</td><td nowrap="nowrap"></td><td nowrap="nowrap">T -&gt; F T'</td><td nowrap="nowrap"></td></tr><tr></tr><tr><td nowrap="nowrap">{*,''}</td><td nowrap="nowrap">{+,$,)}</td><td nowrap="nowrap">T'</td><td nowrap="nowrap">T' -&gt; ''</td><td nowrap="nowrap">T' -&gt; * F T'</td><td nowrap="nowrap"></td><td nowrap="nowrap">T' -&gt; ''</td><td nowrap="nowrap"></td><td nowrap="nowrap">T' -&gt; ''</td></tr><tr></tr><tr><td nowrap="nowrap">{(,id}</td><td nowrap="nowrap">{*,+,$,)}</td><td nowrap="nowrap">F</td><td nowrap="nowrap"></td><td nowrap="nowrap"></td><td nowrap="nowrap">F -&gt; ( E )</td><td nowrap="nowrap"></td><td nowrap="nowrap">F -&gt; id</td><td nowrap="nowrap"></td></tr></tbody></table>
</div>
</td>
</tr></tbody></table>
<p>最大步数: <input id="maximumStepCount" type="text" size="3" onkeyup="resize(this, 3);" onchange="parseInput();" value="100"></p>
<p>输入(tokens): <input id="input" type="text" size="10" onkeyup="resize(this, 10);" onchange="parseInput();" value="id + id" style="color: green;"></p>
<p><input type="button" value="开始"></p>
<br>
<table border="8"><thead><tr><th>跟踪</th><th>树</th></tr></thead><tbody><tr><td>
<table border="1"><thead><tr><th>堆</th><th>输入</th><th>规则</th>
...
<h4><a href="https://www.computercau.club/" target="_blank" title="首页">回到首页</a>

</h>
<h2>使用规则</h>
<h4>'' 为ε</h>
<h4>若遇到如S ->a|b的情况需要列为S -> a和S -> b</h>
<h4>所有文法必须按照 例：S空格->空格A空格B空格''的方式所有符号必须为英文符</h>
</body>
